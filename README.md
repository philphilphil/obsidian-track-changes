...
- *Accept change at cursor*, *Reject change at cursor* — act on the suggestion the cursor is in; bind a hotkey for fast review. Also under *Track changes* in the right-click menu when the cursor is on a change
